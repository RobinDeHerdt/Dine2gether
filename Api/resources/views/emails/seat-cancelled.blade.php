                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/a691a25ff2c949305a23cb193/images/a3436684-4a95-4c0c-8a81-f1e991959f8d.png" width="500" style="max-width:500px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
...
<p style="text-align: center;">Hi {{ $host->first_name }}! We're sorry to inform you that {{ $user->first_name }} has cancelled for {{ $date . ' (' . $time . ')' }}<br><br>
If you have any questions, don't hesitate to ask us!<br>
<br>
